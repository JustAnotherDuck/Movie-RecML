...
# Global variables
TMDB_API_KEY = "8265bd1679663a7ea12ac168da84d2e8"  # Replace with your actual TMDB API key
                    ...
                    if idx < len(recommendations_list):
                        ...
                        with cols[j]:
                            ...
                            if TMDB_API_KEY != "8265bd1679663a7ea12ac168da84d2e8" and 'id' in movie:
                                ...
                                st.write(f"Poster URL: {poster_url}")  # Debug output
                                if poster_url:
                                    try:
                                        ...
                                        st.markdown("<div class='movie-poster'>", unsafe_allow_html=True)
                                        st.image("https://via.placeholder.com/200x300?text=No+Poster+random", use_container_width=True)
                                        st.markdown("</div>", unsafe_allow_html=True)
                                else:
                                    st.markdown("<div class='movie-poster'>", unsafe_allow_html=True)
                                    st.image("https://via.placeholder.com/200x300?text=No+Poster+url+not+there", use_container_width=True)
                                    st.markdown("</div>", unsafe_allow_html=True)
                            else:
                                st.markdown("<div class='movie-poster'>", unsafe_allow_html=True)
                                st.image("https://via.placeholder.com/200x300?text=No+Poster+API+issue", use_container_width=True)
                                st.markdown("</div>", unsafe_allow_html=True)
